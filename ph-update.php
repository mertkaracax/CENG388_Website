...
if (isset($_POST['phone'])){
    $ph = $_POST['phone'];
    $sql = "UPDATE Users SET phone='$ph' WHERE username='$user'";
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="styling/ph-update.css">
    </head>
    <body>
        ...
        <div class= 'main'>
            ...
            <div class= 'form-container'>
                <form method="post">
                    ...
                    <div class="container">
                        <p>Current phone number: <b><?= $phone ?></b></p>
                        <input type="text" placeholder="New Phone Number" name="phone" required>
